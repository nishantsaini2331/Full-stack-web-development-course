...
function Ji(e, n, t) {
    ...
    for (r in n) kc.call(n, r) && !Cc.hasOwnProperty(r) && (l[r] = n[r]);
    if (e && e.defaultProps)
...
function Zu(e, n, t, r) {
    if (Mr) {
        ...
        else if ((Qo(e, r), n & 4 && -1 < Zc.indexOf(e))) {
            for (; l !== null; ) {
                var u = Gt(l);
                if (
                    (u !== null && zs(u),
...
function Nf(e, n) {
    if (Dn)
        return e === "compositionend" || (!eo && Fs(e, n))
            ? ((e = Ds()), (wr = Ju = be = null), (Dn = !1), e)
            : null;
    switch (e) {
        case "paste":
            return null;
...
function As(e) {
    if (e.propertyName === "value" && nl(It)) {
        var n = [];
        Us(n, It, e, Ku(e)), ws(Lf, n);
    }
}
function Rf(e, n, t) {
    e === "focusin"
        ? (ni(), (Ct = n), (It = t), Ct.attachEvent("onpropertychange", As))
        : e === "focusout" && ni();
}
function Of(e) {
...
function Gs(e, n) {
    ...
    if (Tr) throw ((e = uu), (Tr = !1), (uu = null), e);
}
function D(e, n) {
    var t = n[vu];
...
var mu = typeof setTimeout == "function" ? setTimeout : void 0,
    ...
    Wf =
        typeof queueMicrotask == "function"
            ...
            : typeof ai < "u"
            ? function (e) {
                  return ai.resolve(null).then(e).catch(Qf);
              }
            : mu;
function Qf(e) {
    setTimeout(function () {
...
function mn() {
    if (!Dl && $e !== null) {
        ...
        try {
            ...
            throw ($e !== null && ($e = $e.slice(e + 1)), Cs(Yu, mn), l);
        } finally {
            (O = n), (Dl = !1);
        }
    }
...
function ku(e, n, t, r) {
    var l = e.stateNode;
    (l.props = t), (l.state = e.memoizedState), (l.refs = la), ao(e);
    var u = n.contextType;
    typeof u == "object" && u !== null
        ? (l.context = Ce(u))
...
var Kr = {
    ...
    ed = {
        ...
        useSyncExternalStore: function (e, n, t) {
            ...
            return (
                (l.queue = u),
                ki(pa.bind(null, r, u, e), [e]),
                (r.flags |= 2048),
                Wt(9, da.bind(null, r, u, t, n), void 0, null),
                t
            );
        },
        useId: function () {
...
function Ni(e, n, t, r, l) {
    ...
    if ((Xn(n, l), n.stateNode === null))
        _r(e, n), ua(n, t, r), ku(n, t, r, l), (r = !0);
    else if (e === null) {
        var o = n.stateNode,
            i = n.memoizedProps;
        o.props = i;
        ...
        (o.state = p),
            ...
            i !== r || p !== s || ce.current || Ze
                ? (typeof v == "function" &&
                      (Su(n, t, v, r), (s = n.memoizedState)),
                  (i = Ze || yi(n, t, i, r, p, s, c))
                      ? (m ||
        ...
        i !== m || p !== w || ce.current || Ze
            ? (typeof g == "function" &&
                  (Su(n, t, g, r), (w = n.memoizedState)),
              (c = Ze || yi(n, t, c, r, p, w, s) || !1)
                  ? (v ||
...
function ud(e, n, t, r, l, u, o) {
    ...
    if (l.data === "$!") {
        ...
        return (
            (r = i), (u = Error(y(419))), (r = $l(u, r, void 0)), dr(e, n, o, r)
        );
    }
...
function cd(e, n) {
    ...
    for (
        du = { focusedElem: e, selectionRange: t }, Mr = !1, k = n;
        k !== null;
...
function de(e, n) {
    ...
    if (r === 0)
        ...
        if ((t != null && Wo(t), n === 1))
            e.tag === 0 ? Xf(Fi.bind(null, e)) : qs(Fi.bind(null, e)),
                Wf(function () {
                    !(R & 6) && mn();
                }),
                (t = null);
...
ys = Co;
gs = zn;
var Pd = { usingClientEntryPoint: !1, Events: [Gt, jn, rl, vs, hs, Co] },
    vt = {
...
var zd = bi.exports,
    Ai = zd;
(Hl.createRoot = Ai.createRoot), (Hl.hydrateRoot = Ai.hydrateRoot);
function Ld() {
    return qi.jsx("div", { children: "Hello" });
}
Hl.createRoot(document.getElementById("root")).render(qi.jsx(Ld, {}));
